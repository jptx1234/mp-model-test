...
/**
 * 从 MyBatis Plus 的 com.baomidou.mybatisplus.extension.activerecord.Model 复制过来，除了类名以外未做改动
 */
public abstract class ModelWithLog<T extends ModelWithLog<?>> implements Serializable {
